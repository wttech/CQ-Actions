...
package com.cognifide.actions.msg.websocket.message;
...
@Component
@Service
public class SocketMessageProducer implements MessageProducer {
	...
	public boolean sendMessage(String type, Map<String, String> message) {
		...
		return sender.sendMessage(serializedMsg);
	}
}
